...
const Page = () => {
    ...
    return (
        <div>
          ...
          <div className="py-16 bg-black my-11 px-8 md:hidden">
                ...
                <Link href="/contact" className="text-white hover:bg-white items-center inline-flex gap-2 hover:text-black font-bold border p-2 px-8 text-lg">
            ...
            <div className="hidden md:flex w-full my-8 lg:my-16">
                ...
                <div className="w-1/2">
                <Image src={mobilebanner} alt="webcrunchy" className="w-full" />
                </div>
            </div>

        {/* our mobileapp services */}
      <div className="space-y-16">
       {mobileData.map((service, index) => (
    ...
    <div className="bg-black px-4 lg:px-24 py-8 lg:py-12 my-12 md:my-16 text-white">
      <h1 className="text-3xl font-bold lg:text-4xl mb-8">Featured App Development Projects</h1>

    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
    {featuredMobile.map((project) => (
